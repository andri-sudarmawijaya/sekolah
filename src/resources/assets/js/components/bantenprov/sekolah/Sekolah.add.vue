      ...
      <div class="col-md-8 col-lg-9 admin-main">
        ...
        <div class="col-md-12">
          <div class="card mb-3">
            ...
            <div class="card-body">
            <b-card header="Tambah Sekolah" header-tag="h4" class="bg-success-card">
...
export default {
              ...
              if(this.model.tahun >= 2000 && this.model.tahun <= (new Date()).getFullYear())
              {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/sekolah/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/sekolah/create'
                  }
                },
                window.location.href = '#/admin/sekolah/create')
    ...
    mounted: function() {
        axios.get("/sekolah/create").then(response => {
