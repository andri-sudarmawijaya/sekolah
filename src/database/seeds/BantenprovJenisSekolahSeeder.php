 ...
 * [2] $ php artisan db:seed --class=BantenprovJenisSekolahSeeder
 */
class BantenprovJenisSekolahSeeder extends Seeder
{
    /* text color */
    ...
    protected $fileName = "BantenprovJenisSekolahSeeder.csv";
